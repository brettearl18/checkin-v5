...
const getPageTitle = (pathname: string): string => {
  ...
  if (pathname === '/clients/photos1') return 'Photo Gallery';
  if (pathname === '/clients/payment-report') return 'Payment Report';
...
const coachNavItems: NavItem[] = [
  ...
  {
    name: 'Photo Gallery',
    href: '/clients/photos1',
    icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
      </svg>
    ),
    description: 'Before & after client photos'
  },
  {
    name: 'Payment Report',
    href: '/clients/payment-report',
    icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function CoachNavigation() {
  ...
  const isActive = (href: string) => {
    ...
    if (href === '/clients/photos1') return pathname === '/clients/photos1';
    if (href === '/clients/payment-report') return pathname === '/clients/payment-report';
    if (href === '/clients') return pathname.startsWith('/clients') && pathname !== '/clients/photos1' && pathname !== '/clients/payment-report';
