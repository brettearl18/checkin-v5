      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">Comprehensive analysis of Firebase connections, data flows, and analytics processing</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Empty Collections</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-gray-600 text-sm">Firestore collections and their current state</p>
            </div>
            <div className="p-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-gray-600 text-sm">How data moves through the system</p>
            </div>
            <div className="p-6">
              <div className="space-y-4">
          ...
          <div className="bg-white rounded-lg shadow-sm border">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-gray-600 text-sm">How analytics data is calculated and processed</p>
            </div>
            <div className="p-6">
              <div className="space-y-4">
          ...
          <div className="bg-white rounded-lg shadow-sm border">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-gray-600 text-sm">Actions to improve system performance and data quality</p>
            </div>
            <div className="p-6">
              {auditData.recommendations.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">No recommendations - system is running optimally!</p>
                </div>
              )}
            </div>
          </div>
