              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <label className={`relative flex flex-col items-center justify-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 ${
                  ...
                  <input
                    ...
                    className="sr-only"
                  />
                  <svg className={`w-7 h-7 mb-2 transition-colors duration-200 ${selectedRole === 'client' ? 'text-[#daa450]' : 'text-gray-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
                  </svg>
                  <span className={`text-xs font-semibold transition-colors duration-200 ${selectedRole === 'client' ? 'text-[#daa450]' : 'text-gray-600'}`}>
                    Client
                  </span>
                </label>
              </div>
