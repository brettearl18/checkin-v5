...
function LoginContent() {
  ...
  const [selectedRole, setSelectedRole] = useState<'admin' | 'coach' | 'client'>('client');
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-3 tracking-tight">Welcome Back</h1>
          <p className="text-lg text-gray-600">Sign in to your Vana Health account</p>
        </div>
      </div>
        ...
        <div className="bg-white py-10 px-6 sm:px-10 shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_10px_10px_-5px_rgba(0,0,0,0.04)] rounded-3xl border border-gray-100">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link
                  href="/reset-password"
                  className="text-sm font-medium text-[#daa450] hover:text-[#c89440] underline transition-colors duration-200"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <label className={`relative flex flex-col items-center justify-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 ${
                  selectedRole === 'coach'
                    ? 'border-[#daa450] bg-[#fef9e7] shadow-md scale-105'
                  ...
                  <input
                    ...
                    className="sr-only"
                  />
                  <svg className={`w-7 h-7 mb-2 transition-colors duration-200 ${selectedRole === 'coach' ? 'text-[#daa450]' : 'text-gray-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                  <span className={`text-xs font-semibold transition-colors duration-200 ${selectedRole === 'coach' ? 'text-[#daa450]' : 'text-gray-600'}`}>
                    Coach
                  </span>
                </label>

                {/* Client Option */}
                <label className={`relative flex flex-col items-center justify-center p-5 border-[3px] rounded-xl cursor-pointer transition-all duration-200 ${
                  selectedRole === 'client'
                    ? 'border-[#daa450] bg-[#fef9e7] shadow-md scale-110'
                    : 'border-gray-200 bg-white hover:border-gray-300 hover:shadow-sm scale-105'
                }`}>
                  <input
                    type="radio"
                    name="role"
                    ...
                    className="sr-only"
                  />
                  <svg className={`w-8 h-8 mb-2 transition-colors duration-200 ${selectedRole === 'client' ? 'text-[#daa450]' : 'text-gray-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                  </svg>
                  <span className={`text-sm font-semibold transition-colors duration-200 ${selectedRole === 'client' ? 'text-[#daa450]' : 'text-gray-600'}`}>
                    Client
                  </span>
                </label>
                ...
                <label className={`relative flex flex-col items-center justify-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 ${
                  ...
                  <input
                    ...
                    className="sr-only"
                  />
                  <svg className={`w-7 h-7 mb-2 transition-colors duration-200 ${selectedRole === 'admin' ? 'text-[#daa450]' : 'text-gray-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                  <span className={`text-xs font-semibold transition-colors duration-200 ${selectedRole === 'admin' ? 'text-[#daa450]' : 'text-gray-600'}`}>
                    Admin
                  </span>
                </label>
              </div>
            ...
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 text-[#daa450] focus:ring-[#daa450] border-gray-300 rounded transition-colors duration-200"
              />
          ...
          <div className="mt-6">
            <Link
              ...
              className="w-full inline-flex justify-center items-center py-3 px-4 border-2 border-gray-200 rounded-xl shadow-sm bg-white text-sm font-semibold text-gray-900 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 hover:shadow-md"
            >
