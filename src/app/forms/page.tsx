              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex space-x-3">
                  <Link
                    ...
                    className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-2xl text-sm font-medium transition-all duration-200 shadow-sm flex items-center gap-2"
                  >
                  ...
                  <Link
                    ...
                    className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-2xl text-sm font-medium transition-all duration-200 shadow-sm"
                  >
                    Create Question
                  </Link>
                  <Link
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              <div className="bg-white rounded-3xl shadow-[0_1px_3px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="text-sm text-gray-600 mt-1">All forms</div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl shadow-[0_1px_3px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden">
                <div className="bg-orange-50 px-6 py-4 border-b-2 border-orange-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm font-medium text-gray-700">Active Forms</span>
                  </div>
                </div>
                <div className="p-6">
              ...
              <div className="bg-white rounded-3xl shadow-[0_1px_3px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden">
                <div className="bg-orange-50 px-6 py-4 border-b-2 border-orange-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm font-medium text-gray-700">Avg Questions</span>
                  </div>
                </div>
                <div className="p-6">
                  <div className="text-3xl font-bold text-gray-900">{stats.avgQuestions}</div>
                  <div className="text-sm text-gray-600 mt-1">Per form</div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl shadow-[0_1px_3px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden">
                <div className="bg-orange-50 px-6 py-4 border-b-2 border-orange-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm font-medium text-gray-700">Inactive Forms</span>
                  </div>
                </div>
                <div className="p-6">
                ...
                <div className="p-12 text-center">
                  ...
                  <div className="flex justify-center space-x-4">
                    <button
                      ...
                      className="inline-flex items-center px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-2xl text-sm font-medium transition-all duration-200 shadow-sm"
                    >
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-orange-100 text-orange-700 border border-orange-200">
                        ...
                        <div className="ml-8 flex items-center space-x-3">
                          {form.isStandard && (
                            <button
                              ...
                              className="px-4 py-2 text-sm text-orange-700 bg-orange-100 rounded-2xl hover:bg-orange-200 font-medium transition-all duration-200 border border-orange-200"
                            >
                              Copy Form
                            </button>
                          )}
                          {!form.isStandard && !form.isArchived && (
                            <button
                              ...
                              className={`px-4 py-2 text-sm rounded-2xl font-medium transition-all duration-200 border ${
                                form.isActive
                                  ? 'text-orange-700 bg-orange-100 hover:bg-orange-200 border-orange-200'
                                  : 'text-[#34C759] bg-[#34C759]/10 hover:bg-[#34C759]/20 border-[#34C759]/20'
                              }`}
                            >
                          ...
                          {!form.isArchived && (
                            <button
                              ...
                              className="px-4 py-2 text-sm text-orange-700 bg-orange-100 rounded-2xl hover:bg-orange-200 font-medium transition-all duration-200 disabled:opacity-50 border border-orange-200"
                            >
                          ...
                          <button
                            ...
                            className="px-4 py-2 text-sm text-[#FF3B30] bg-[#FF3B30]/10 rounded-2xl hover:bg-[#FF3B30]/20 font-medium transition-all duration-200 border border-[#FF3B30]/20"
                          >
                            Delete
                          </button>
                          <Link
                            href={`/forms/${form.id}`}
                            className="px-4 py-2 text-sm text-[#007AFF] bg-[#007AFF]/10 rounded-2xl hover:bg-[#007AFF]/20 font-medium transition-all duration-200 border border-[#007AFF]/20"
                          >
                            View
                          </Link>
                          {!form.isStandard && !form.isArchived && (
                            <Link
                              ...
                              className="px-4 py-2 text-sm text-gray-700 bg-gray-100 rounded-2xl hover:bg-gray-200 font-medium transition-all duration-200 border border-gray-200"
                            >
                              Edit
                            </Link>
                          )}
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full mx-4">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-2xl text-gray-900 focus:ring-2 focus:ring-orange-500 focus:border-transparent"
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="flex-1 px-4 py-2 text-gray-700 bg-gray-100 rounded-2xl hover:bg-gray-200 font-medium transition-colors"
                disabled={isCopying}
              >
                Cancel
              </button>
            ...
            <div className="px-6 py-4 space-y-4">
              <div className="bg-orange-50 border border-orange-200 rounded-2xl p-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-orange-800 mb-2">Warning: This action cannot be undone</h4>
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <button
                  ...
                  disabled={isDeleting}
                  className="flex-1 px-4 py-2 bg-[#FF3B30] hover:bg-[#FF2D20] text-white rounded-2xl font-medium transition-colors disabled:opacity-50 shadow-sm"
                >
